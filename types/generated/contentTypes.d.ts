...
export interface ApiConditionsMetConditionsMet
  extends Struct.CollectionTypeSchema {
  collectionName: 'conditions_mets';
  info: {
    description: '';
...
export interface ApiExecutionAccumulatorExecutionAccumulator
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::execution-accumulator.execution-accumulator'
    > &
      Schema.Attribute.Private;
...
export interface ApiExecutionExecution extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    execution_accumulators: Schema.Attribute.Relation<
      'oneToMany',
      'api::execution-accumulator.execution-accumulator'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    conditions_mets: Schema.Attribute.Relation<
      'oneToMany',
      'api::conditions-met.conditions-met'
    >;
    ...
    ownerId: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    state: Schema.Attribute.Enumeration<['draft', 'review', 'published']> &
      Schema.Attribute.Required &
...
export interface ApiTaxonomyTaxonomy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    term_relationships: Schema.Attribute.Relation<
      'oneToMany',
      'api::term-relationship.term-relationship'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTermRelationshipTermRelationship
  extends Struct.CollectionTypeSchema {
  collectionName: 'term_relationships';
  info: {
    description: '';
    displayName: 'TermRelationship';
    pluralName: 'term-relationships';
    singularName: 'term-relationship';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::conditions-met.conditions-met': ApiConditionsMetConditionsMet;
